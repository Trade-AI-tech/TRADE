...
export { loadDeps, buildBaseTrades, makeCtx, buildConfigs, evaluateConfig, permutationTest, summarise, simulateTradeFromLevels, assertNoTestBarsHere, VETO_SLUGS, SHORT, DEFAULT_B, DEFAULT_SEED };
