...
export { permutationTest, sumOfRandomSubset, buildBaseTrades, makeCtx, evaluateConfig, buildConfigs, summarise, simulateTradeFromLevels, runTimeframe, selfTest, loadDeps, assertNoTestBarsHere, VETO_SLUGS, SHORT, DEFAULT_B, DEFAULT_SEED };
