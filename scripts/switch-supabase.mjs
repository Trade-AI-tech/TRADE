 ...
 *   3. GitHub Actions secrets — ตัวสแกนที่ตั้งหน้าปัดทุก 15 นาที
 *
 * วิธีใช้:
...
═══ ต่อไปต้องทำเอง ═══
  ...
  3. watchlist ปล่อยว่างได้เลย — ตัวสแกนครอบคลุมจักรวาลเองอยู่แล้ว (XAUUSD ตัวเดียว
       ตั้งแต่ 2026-08-29 ตามคำสั่งเจ้าของว่าเทรดทองอย่างเดียว)
       ⚠ symbol ที่อยู่นอกจักรวาลจะ "ไม่ถูกสแกน" แม้ใส่ลง watchlist (ดู buildScanTargets
         ใน src/lib/universe.ts) — ใส่ไปก็ได้แค่แถวในตาราง ไม่ได้สัญญาณ
