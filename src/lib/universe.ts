 ...
 *     (โลหะ 2 + ค่าเงิน 16) เหตุผลและตัวเลขเทียบรายตลาดอยู่ในบล็อก ⛔ ข้างล่าง
 *   - 18 symbol × 2 timeframe (1D range 1y + 1H range 3mo) = 36 คำขอ/รอบ
 *     (ตัวเลขเวลาข้างล่างวัดตอนยังมี 57 ตัว = 114 คำขอ ของจริงตอนนี้เร็วกว่านั้นราว 68%)
...
export const SYMBOL_UNIVERSE: readonly UniverseSymbol[] = [
  ...
  // ⛔ ถอดออกจากจักรวาลแล้วสามกลุ่ม — เหตุผลคนละแบบ อย่ารวมกัน
  //
