 ...
 *   - 57 symbol × 2 timeframe (1D range 1y + 1H range 3mo) = 114 คำขอ/รอบ
...
export const SYMBOL_UNIVERSE: readonly UniverseSymbol[] = [
  ...
  // ── คริปโต (9) — 1D 366 แท่ง / 1H 2,189 แท่ง ──────────────────────────────
  // เลือกเฉพาะตัวที่มูลค่าซื้อขายจริงสูงพอจะเข้าออกได้ ไม่เอาเหรียญเล็ก
  // ข้อดีสำหรับเทรดสั้น: เดิน 24/7 รวมเสาร์อาทิตย์ = ช่วงที่ตลาดอื่นปิดยังมีของให้สแกน
  // ⚠ ข้อควรระวัง: กลุ่มนี้ระยะ stop กว้างกว่าตลาดอื่นชัดเจน (วัดได้ p75 = 5.8% ของราคา
  //   ขณะที่ FOREX อยู่ที่ 1.7%) เพดาน maxStopDistancePct จึงกินคริปโตก่อนใครเสมอ
  { symbol: 'BTC', name: 'บิตคอยน์', market: 'CRYPTO' },
  { symbol: 'ETH', name: 'อีเธอเรียม', market: 'CRYPTO' },
  { symbol: 'BNB', name: 'BNB', market: 'CRYPTO' },
  { symbol: 'SOL', name: 'โซลานา', market: 'CRYPTO' },
  { symbol: 'XRP', name: 'XRP', market: 'CRYPTO' },
  { symbol: 'DOGE', name: 'โดชคอยน์', market: 'CRYPTO' },
  { symbol: 'ADA', name: 'คาร์ดาโน', market: 'CRYPTO' },
  { symbol: 'AVAX', name: 'อวาแลนช์', market: 'CRYPTO' },
  { symbol: 'LINK', name: 'เชนลิงก์', market: 'CRYPTO' },

  // ── หุ้นสหรัฐ (12) — 1D 251 แท่ง / 1H 442 แท่ง ────────────────────────────
  // สภาพคล่องสูงสุด สเปรดแคบ และคนไทยเข้าถึงได้ผ่านโบรกต่างประเทศ/DR
  // SPY กับ QQQ เป็น ETF ดัชนี ใส่ไว้เป็น "ตัวชี้ทิศตลาดรวม" — เวลามันให้สัญญาณ
  // มักแปลว่าทั้งกลุ่มกำลังไปทางเดียวกัน ไม่ใช่เรื่องเฉพาะตัวหุ้น
  // ⚠ 1H ได้แค่ 442 แท่ง เพราะตลาดเปิดวันละ 6.5 ชม. — พอสำหรับ generateSignal (ต้องการ 50)
  //   แต่ไม่ถึง 200 แท่งต่อ "หน้าต่างล่าสุด" ในบางช่วง จึงมักไม่มี MA200 มายืนยันเทรนด์
  { symbol: 'AAPL', name: 'Apple', market: 'US_STOCK' },
  { symbol: 'MSFT', name: 'Microsoft', market: 'US_STOCK' },
  { symbol: 'NVDA', name: 'NVIDIA', market: 'US_STOCK' },
  { symbol: 'AMZN', name: 'Amazon', market: 'US_STOCK' },
  { symbol: 'GOOGL', name: 'Alphabet (Google)', market: 'US_STOCK' },
  { symbol: 'META', name: 'Meta', market: 'US_STOCK' },
  { symbol: 'TSLA', name: 'Tesla', market: 'US_STOCK' },
  { symbol: 'AMD', name: 'AMD', market: 'US_STOCK' },
  { symbol: 'NFLX', name: 'Netflix', market: 'US_STOCK' },
  { symbol: 'JPM', name: 'JPMorgan Chase', market: 'US_STOCK' },
  { symbol: 'SPY', name: 'ดัชนี S&P 500 (SPY)', market: 'US_STOCK' },
  { symbol: 'QQQ', name: 'ดัชนี Nasdaq 100 (QQQ)', market: 'US_STOCK' },
